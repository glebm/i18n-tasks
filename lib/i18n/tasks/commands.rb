...
module I18n::Tasks
  class Commands < CommandsBase
    ...
    cmd :missing do |opt = {}|
      opt[:locales] = locales_opt(opt[:arguments].presence || opt[:locales])
    ...
    cmd :normalize do |opt = {}|
      i18n_task.normalize_store! locales_opt(opt[:arguments].presence || opt[:locales])
    end
    ...
    cmd :remove_unused do |opt = {}|
      locales = locales_opt(opt[:arguments].presence || opt[:locales])
